 ...
 * @return {Object} - this
 */
function _simpleColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_simpleColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_simpleColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_simpleColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _simpleColor object.
 *
 * @since Simple 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function simpleColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _simpleColor( backgroundColor, accentHue );
