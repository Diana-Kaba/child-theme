...
if ( ! class_exists( 'simple_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 *
	 * @since Simple 1.0
	 */
	class simple_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'simple_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'simple_get_localized_font_family_elements',
				array(
			...
			return simple_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
		}
	}
}
