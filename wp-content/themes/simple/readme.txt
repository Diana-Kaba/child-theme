...
Simple WordPress Theme, Copyright 2019-2024 WordPress.org
...
Simple is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Simple bundles the following third-party resources:
...
Bespoke Icons Created For Simple
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- simple_SVG_Icons
- simple_the_theme_svg()
- simple_get_theme_svg()
- simple_nav_menu_social_icons()
